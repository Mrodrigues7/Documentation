...
Puedes definir porcentaje de facturación, referencia (per cliente) y fechas.
...
Puede definir diferentes condiciones de facturación para las líneas de entrega de clientes
